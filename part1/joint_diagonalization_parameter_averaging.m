function [f, theta] = joint_diagonalization_parameter_averaging(X, m)
% joint_diagonalization_parameter_averaging Performs time smoothing and joint diagonalization.
